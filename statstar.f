...
c
      ...
      do 60 ic = 1, istop
          ...
          write(20,4000) r(i), Qm, L_r(i), M_r(i), T(i), P(i), rho(i),
     1        kappa(i),epslon(i), clim, rcf, dlPdlT(i)
   60 continue
      write(*,9000)
c
c  Format statements
c
 ...
 2500 format(' ',/,' Notes: ',/,
     ...
     6 ' labeled by *',//)
 3000 format(' ',5x,'r',7x,'Qm',9x,'L_r',9x,'M_r',9x,'T',9x,'P',9x,
     1 'rho',9x,'kap',9x,'eps',3x,'clim',3x,'rcf',3x,'dlPdlT')
c 4000 format(1p8e10.2,2a2,0pf6.1)
 4000  format(1pe10.2,',',1pe10.2,',',1pe10.2,',',1pe10.2,',',
